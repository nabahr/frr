...
def test_pim_dense_flood(request):
    ...
    flood_dict = {
        "r1": {"src_address": "10.100.0.2", "iif": "r1-eth1", "oil": "r1-eth0", "joinState": "NotJoined"},
        "r2": {"src_address": "10.100.0.2", "iif": "r2-eth0", "oil": ["r2-eth1", "r2-eth2"], "joinState": "Joined"},
        "r3": {"src_address": "10.100.0.2", "iif": "r3-eth0", "oil": ["r3-eth1", "r3-eth23"], "joinState": "Joined"}
    }

    step("Verify 'show ip mroute' showing routes with no OIL on all the nodes")
    for dut, data in flood_dict.items():
...
def test_pim_dense_prune(request):
    "Test PIM Dense mode basic functionality"
    tgen = get_topogen()
    tc_name = request.node.name
    write_test_header(tc_name)
    ...
    prune_dict = {
        ...
        "r2": {"src_address": "10.100.0.2", "iif": "r2-eth0", "oil": "none", "joinState": "Joined"},
        "r3": {"src_address": "10.100.0.2", "iif": "r3-eth0", "oil": "none", "joinState": "Joined"}
    }
...
def test_pim_dense_graft_r4(request):
    ...
    graft_dict = {
        "r4": {"src_address": "10.100.0.2", "iif": "r4-eth0", "oil": "r4-eth1", "joinState": "Joined"},
        "r3": {"src_address": "10.100.0.2", "iif": "r3-eth0", "oil": "none", "joinState": "Joined"},
        "r2": {"src_address": "10.100.0.2", "iif": "r2-eth0", "oil": "r2-eth2", "joinState": "Joined"},
        "r1": {"src_address": "10.100.0.2", "iif": "r1-eth1", "oil": "r1-eth0", "joinState": "Joined"}
    }
...
def test_pim_dense_graft_r5(request):
    ...
    graft_dict = {
        "r5": {"src_address": "10.100.0.2", "iif": "r5-eth0", "oil": "r5-eth1", "joinState": "Joined"},
        "r4": {"src_address": "10.100.0.2", "iif": "r4-eth0", "oil": "r4-eth1", "joinState": "Joined"},
        "r3": {"src_address": "10.100.0.2", "iif": "r3-eth0", "oil": "r3-eth1", "joinState": "Joined"},
        "r2": {"src_address": "10.100.0.2", "iif": "r2-eth0", "oil": ["r2-eth2", "r2-eth1"], "joinState": "Joined"},
        "r1": {"src_address": "10.100.0.2", "iif": "r1-eth1", "oil": "r1-eth0", "joinState": "Joined"}
    }
...
def test_pim_dense_graft_r6(request):
    ...
    graft_dict = {
        "r6": {"src_address": "10.100.0.2", "iif": "r6-eth0", "oil": "r6-eth1", "joinState": "Joined"},
        "r5": {"src_address": "10.100.0.2", "iif": "r5-eth0", "oil": "r5-eth1", "joinState": "Joined"},
        "r4": {"src_address": "10.100.0.2", "iif": "r4-eth0", "oil": "r4-eth1", "joinState": "Joined"},
        "r3": {"src_address": "10.100.0.2", "iif": "r3-eth0", "oil": ["r3-eth1", "r3-eth2"], "joinState": "Joined"},
        "r2": {"src_address": "10.100.0.2", "iif": "r2-eth0", "oil": ["r2-eth2", "r2-eth1"], "joinState": "Joined"},
        "r1": {"src_address": "10.100.0.2", "iif": "r1-eth1", "oil": "r1-eth0", "joinState": "Joined"}
    }
...
def test_pim_dense_prune_r4(request):
    ...
    prune_dict = {
        ...
        "r5": {"src_address": "10.100.0.2", "iif": "r5-eth0", "oil": "r5-eth1", "joinState": "Joined"},
        "r3": {"src_address": "10.100.0.2", "iif": "r3-eth0", "oil": ["r3-eth1", "r3-eth2"], "joinState": "Joined"},
        "r2": {"src_address": "10.100.0.2", "iif": "r2-eth0", "oil": "r2-eth1", "joinState": "Joined"},
        "r1": {"src_address": "10.100.0.2", "iif": "r1-eth1", "oil": "r1-eth0", "joinState": "Joined"}
    }
...
def test_pim_dense_prune_r5(request):
    ...
    prune_dict = {
        "r6": {"src_address": "10.100.0.2", "iif": "r6-eth0", "oil": "r6-eth1", "joinState": "Joined"},
        "r3": {"src_address": "10.100.0.2", "iif": "r3-eth0", "oil": "r3-eth2", "joinState": "Joined"},
        "r2": {"src_address": "10.100.0.2", "iif": "r2-eth0", "oil": "r2-eth1", "joinState": "Joined"},
        "r1": {"src_address": "10.100.0.2", "iif": "r1-eth1", "oil": "r1-eth0", "joinState": "Joined"}
    }
